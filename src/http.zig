...
pub const httpRequest = struct {
    ...
    pub fn setupClient(self: *@This()) void {
    ...
    pub fn makeHttpRequest(self: *@This()) !void {
        self.setupClient();
        self.setupWriter();
        defer self.destroy();
    ...
    pub fn writeToStdout(self: *@This(), buf: []u8) !void {
    ...
    pub fn freeHeaders(self: *@This(), headers: *std.ArrayList(std.http.Header)) void {
    ...
    pub fn processHeaders(self: @This(), headers: *std.ArrayList(std.http.Header)) !void {
